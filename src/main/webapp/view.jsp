...
<%
    ...
    Bbs bbs = new BbsDAO().getBbs(bbsID); // 유효한 글일 경우
%>
...
<div class="container">
    <div class="row">
        ...
        <!-- 작성자 아이디와 세션아이디가 일치할 경우 -->
        <%
            if (userID != null && userID.equals(bbs.getUserID())) {
        %>
        <a href="update.jsp?bbsID=<%=bbsID%>" class="btn btn-primary">수정</a>
        <a onclick="return confirm('작성글을 삭제하시겠습니까?')" href="deleteAction.jsp?bbsID=<%=bbsID%>" class="btn btn-primary">삭제</a>
        <%
            }
        %>
    </div>
